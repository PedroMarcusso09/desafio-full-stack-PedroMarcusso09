...
import { IClient, IClientContextType, IClientLoginData, IClientRegisterData, IClientLoginResponse } from './@types'
import axios from "axios";

export const ClientContext = createContext<IClientContextType>({} as IClientContextType);
...
export const ClientProvider: FC<{ children: ReactNode }> = ({ children }) => {
    ...
    return (
        <ClientContext.Provider value={{ client, clientRegister, clientLogin, clientLogout, loading }}>
            {children}
